...
var __extends = this && this.__extends || function() {
  ...
  , GameMenuChanger = function(g) {
    function b() {
        ...
        for (var b = LevelPart.SNAKE_BODY_START; b < LevelPart.SNAKE_BODY_START + 9; b++)
            LevelPart.savedSnakeParts.push(new SnakePart(-1,-1,b,!1));
        ...
        document.addEventListener("adBreakStart", Preferences.gameMenuChanger.onadBreakStart);
        document.addEventListener("adBreakComplete", Preferences.gameMenuChanger.onadBreakComplete);
        if (this.wnd.parent)
            for (; this.wnd.parent != this.wnd; )
                this.wnd = this.wnd.parent;
    ...
    b.prototype.KeyUp = function(a) {
        if (Preferences.lvlLink)
            Preferences.lvlLink.KeyUp(a);
    }
    ;
    b.prototype.KeyDown = function(a) {
        if (Preferences.lvlLink)
            Preferences.lvlLink.KeyDown(a);
    }
    ;
    b.prototype.onadBreakStart = function() {
        SoundController.musicStop();
    }
    ;
    b.prototype.Focus = function() {
        Preferences.gameMenuChanger.wnd.focus();
        console.log('Focused!');
    }
    ;
    b.prototype.onadBreakComplete = function() {
        setTimeout(Preferences.gameMenuChanger.Focus, 1000);
        if (!Preferences.bMusicOff)
            SoundController.musicPlay();
        if (Preferences.nextMenu) {
            if (Preferences.nextMenu.buttonPressed == 1) {
                Preferences.nextMenu.needPosition = "hide";
                if (Preferences.nextMenu.inProgress)
                    Preferences.nextMenu.reasonOfHide = 1;
                if (Preferences.nextMenu.inProgress || Preferences.nextMenu.nm.currentLabel == "hide") {
                    return;
                }
                Preferences.nextMenu.inProgress = true;
                Preferences.nextMenu.nm.play();
                Preferences.nextMenu.addEventListener("tick", Preferences.nextMenu.checkForEndHide);
                Preferences.curLevel++;
                Preferences.gameMenuChanger.showGame();
            } else if (Preferences.nextMenu.buttonPressed == 3) {
                Preferences.nextMenu.needPosition = "hide";
                if (Preferences.nextMenu.inProgress)
                    Preferences.nextMenu.reasonOfHide = 3;
                if (Preferences.nextMenu.inProgress || Preferences.nextMenu.nm.currentLabel == "hide") {
                    return;
                }
                Preferences.nextMenu.inProgress = true;
    ...
    b.prototype.showGame = function(a) {
        void 0 === a && (a = !1);
        this.inProgress || (a ? (Preferences.SHOW_FAIL_MENU || Preferences.inGameMenu.stopRestartEff(),
        Preferences.lossCount++,
        3 <= Preferences.lossCount && Preferences.inGameMenu.startWalkEffect(),
        this.inProgress = !0,
        this.nextMenu.hide(!0),
        this.restartAnim.gotoAndStop(0),
        Preferences.playTo(this.restartAnim, "visible", this.onRestartMiddle),
        this.restartAnim.visible = !0) : ("menu" == this.GMC.currentLabel ? (Preferences.inGameMenu.gameView(),
        "menu" == this.GNM.currentLabel && (this.GNM.stop(),
        this.GNM.gotoAndStop("game"),
        this.nextMenu.gotoAndStop("hide")),
        this.nextMenu.hide(),
        Preferences.playTo(this.GMC, "game", this.gameShown),
        this.inProgress = !0,
        this.game.fromMenu(this.levelMC, null, Preferences.curLevel, 0)) : ("game" == this.GNM.currentLabel && (Preferences.playTo(this.GNM, "nextLevel", this.nextLevelShown),
        this.nextMenu.hide(),
        this.inProgress = !0,
        31 == Preferences.curLevel && Preferences.inGameMenu.show31level()),
        this.game.fromMenu(null, this.nexLevelMC, 0, Preferences.curLevel)),
        Preferences.bSoundOff || createjs.Sound.play("TVzhuh")),
        Preferences.inGameMenu.setLevelNum(),
        this.setProperFon())
    }
    ;
    ...
    b.prototype.showMenu = function() {
        ...
        Preferences.bSoundOff || createjs.Sound.play("TVzhuh"),
        Preferences.playTo(this.GMC, "menu"),
        this.mainMenu.setUpButtons(),
        Preferences.inGameMenu.menuView(),
        this.nextMenu.hide(),
        this.setProperFon())
    }
    ;
    b.prototype.showNextMenu = function(a) {
        a || (Preferences.levelResults[Preferences.curLevel] = 2,
        Preferences.saveResults(),
        Preferences.updateResults());
        !a || Preferences.SHOW_FAIL_MENU ? (this.nextMenu.setState(Preferences.curLevel, a),
        this.nextMenu.visible = !0) : Preferences.inGameMenu.startRestartEff()
    }
    ;
...
var InGameMenu = function(g) {
    ...
    b.prototype.onAdded = function(a) {
        ...
        this.setUpButton(this.butMusic, 0);
        ...
        this.setUpButton(this.igMenu.dbut, !1);
        this.igMenu.dbut.addEventListener("mousedown", this.ondbut);
        this.igMenu.dbut.addEventListener("pressup", this.ondbutUp);
        0 == createjs.Touch.isSupported() && (this.igMenu.lbut.visible = !1,
        this.igMenu.ubut.visible = !1,
        this.igMenu.rbut.visible = !1,
        this.igMenu.dbut.visible = !1)
    }
    ;
    ...
    b.prototype.setUpButton = function(a, b, d) {
        ...
        a.mouseChildren = !1,
        a.param = b,
        Preferences.setUpButton(a),
        d && a.cache(-48, -48, 95, 95))
    }
    ;
    b.prototype.onMusic = function(a) {
        ...
        Preferences.bMusicOff ? (a.gotoAndStop(1),
        SoundController.musicStop()) : (a.gotoAndStop(0),
        SoundController.musicPlay());
    ...
    b.prototype.menuView = function() {
        "level31" == Preferences.inGameMenu.igMenu.currentLabel ? Preferences.playTo(Preferences.inGameMenu.igMenu, Preferences.inGameMenu.igMenu.totalFrames - 1, this.menuAfter31) : Preferences.playTo(Preferences.inGameMenu.igMenu, "menu")
    }
    ;
...
var NextMenu = function(g) {
    function b() {
        ...
        a.nextBut && (a.nextBut.cache(-33, -33, 67, 70),
        Preferences.setUpButton(a.nextBut));
        a.retryBut && (a.retryBut.cache(-33, -33, 67, 70),
        Preferences.setUpButton(a.retryBut));
        a.moreBut && (a.moreBut.cache(-33, -33, 67, 70),
        Preferences.setUpButton(a.moreBut));
        a.menuBut && (a.menuBut.cache(-33, -33, 67, 70),
        Preferences.setUpButton(a.menuBut));
    ...
    b.prototype.setState = function(a, b) {
        ...
        if (!this.inProgress && "show" != this.currentLabel) {
            ...
            if (c = this.menu.cifry)
                c.cacheCanvas && c.uncache(),
                c.gotoAndStop(a - 1),
                c.cache(-25, -15, 50, 35);
            ...
            this.nextBut && (this.nextBut.cacheCanvas && this.nextBut.uncache(),
            this.nextBut.gotoAndStop(0),
            b || 29 != this.representedLevel || 0 != Preferences.levelResults[30] ? (this.nextBut.addEventListener("click", this.onNext),
            this.nextBut.getChildAt(0).gotoAndStop(0)) : this.nextBut.getChildAt(0).gotoAndStop(1),
            this.nextBut.cache(-33, -33, 67, 70));
            this.retryBut && (this.retryBut.gotoAndStop(0),
            this.retryBut.addEventListener("click", this.onRetry));
            this.moreBut && (this.moreBut.gotoAndStop(0),
            this.moreBut.addEventListener("click", this.onMore));
            this.menuBut && (this.menuBut.gotoAndStop(0),
            this.menuBut.addEventListener("click", this.onMenu));
    ...
    b.prototype.checkForShow = function(a) {
        "show" == Preferences.nextMenu.nm.currentLabel && (Preferences.nextMenu.removeEventListener("tick", Preferences.nextMenu.checkForShow),
        Preferences.nextMenu.inProgress = !1,
        Preferences.nextMenu.star && Preferences.nextMenu.star.play(),
        Preferences.nextMenu.nm.stop(),
        "hide" == Preferences.nextMenu.needPosition ? Preferences.nextMenu.hide() : Preferences.bSoundOff || createjs.Sound.play("TPortal_2"))
    }
    ;
    b.prototype.onNext = function(a) {
        if (!Preferences.SPONSOR_MODE && Preferences.levelResults[Preferences.nextMenu.representedLevel + 1] == 0)
            return;
        if (parent && parent.cmgGameEvent)
            parent.cmgGameEvent("start", Preferences.curLevel.toString());
        Preferences.nextMenu.buttonPressed = 1;
        cmgAdBreak();
    }
    ;
    b.prototype.onRetry = function(a) {
        ...
        Preferences.nextMenu.inProgress || "hide" == Preferences.nextMenu.nm.currentLabel || (Preferences.nextMenu.inProgress = !0,
        Preferences.nextMenu.nm.play(),
        Preferences.nextMenu.addEventListener("tick", Preferences.nextMenu.checkForEndHide),
        Preferences.bSoundOff || createjs.Sound.play("TRestart"),
        Preferences.gameMenuChanger.showGame(!0))
    ...
    ;
    b.prototype.onMenu = function(a) {
        Preferences.nextMenu.buttonPressed = 3;
        if (!Preferences.nextMenu.bIsFail) {
            cmgAdBreak();
        } else {
            Preferences.gameMenuChanger.onadBreakComplete();
        }
        ;
    }
    ;
    b.prototype.checkForEndHide = function(a) {
        if ("hide" == Preferences.nextMenu.nm.currentLabel)
            if (Preferences.nextMenu.inProgress = !1,
            Preferences.nextMenu.nm.stop(),
            Preferences.nextMenu.removeEventListener("tick", Preferences.nextMenu.checkForEndHide),
            "show" == Preferences.nextMenu.needPosition)
                Preferences.nextMenu.setState(Preferences.curLevel, Preferences.nextMenu.bIsFail);
            else
                switch (Preferences.nextMenu.reasonOfHide) {
                case 1:
                    Preferences.curLevel++;
                    Preferences.gameMenuChanger.showGame();
                    break;
    ...
    b.prototype.hide = function(a) {
        void 0 === a && (a = !1);
        Preferences.nextMenu.needPosition = "hide";
        a ? (Preferences.nextMenu.nm.gotoAndStop("hide"),
        Preferences.nextMenu.inProgress = !1) : Preferences.nextMenu.inProgress || "hide" == Preferences.nextMenu.nm.currentLabel || (Preferences.nextMenu.inProgress = !0,
        Preferences.nextMenu.nm.play(),
        Preferences.nextMenu.addEventListener("tick", Preferences.nextMenu.checkForEndHide))
    }
    ;
...
var MainMenu = function(g) {
    ...
    b.prototype.init = function() {
        ...
        this.buttonPlay.addEventListener("click", this.onRight);
    ...
    b.prototype.onTick = function(a) {
        Preferences.mainMenu.mainmenu.currentLabel == Preferences.mainMenu.needFrameName && (Preferences.mainMenu.mainmenu.stop(),
        Preferences.mainMenu.needFrameName = "")
    }
    ;
    b.prototype.setUpButtons = function() {
        ...
        for (var d = 1; 15 >= d; d++)
            if (a = b["b" + d])
                a.uniqNum = d,
                this.SetUpLevelButton(a),
                this.setUpButton(a, 0);
    ...
    b.prototype.cacheAll = function() {
        ...
        Preferences.mainMenu.mainmenu.mmenu.cacheCanvas || Preferences.mainMenu.mainmenu.mmenu.cache(-424, -122, 763, 348)
    }
    ;
    b.prototype.onRight = function(a) {
        if ("levels2" == Preferences.mainMenu.mainmenu.currentLabel)
            Preferences.mainMenu.onLeft(a);
        else {
            if ("start" == Preferences.mainMenu.mainmenu.currentLabel)
                parent && parent.cmgGameEvent && parent.cmgGameEvent("start"),
                Preferences.mainMenu.needFrameName = "mainmenu";
            else if ("mainmenu" == Preferences.mainMenu.mainmenu.currentLabel)
                Preferences.mainMenu.needFrameName = "levels1";
            else if ("levels1" == Preferences.mainMenu.mainmenu.currentLabel)
                Preferences.mainMenu.needFrameName = "levels2";
            else if ("levels1right" == Preferences.mainMenu.mainmenu.currentLabel)
                Preferences.mainMenu.needFrameName = "levels2",
                Preferences.mainMenu.mainmenu.gotoAndStop("levels1");
            else if ("mainmenuright" == Preferences.mainMenu.mainmenu.currentLabel)
                Preferences.mainMenu.needFrameName = "levels1",
                Preferences.mainMenu.mainmenu.gotoAndStop("mainmenu");
            else
                return;
            Preferences.mainMenu.mainmenu.play();
            Preferences.mainMenu.inProgress = !0;
            Preferences.bSoundOff || createjs.Sound.play("TVzhuh");
            1 == Preferences.mainMenu.curList ? Preferences.mainMenu.curList = 2 : 2 == Preferences.mainMenu.curList && (Preferences.mainMenu.curList = 1)
        }
    }
    ;
    b.prototype.onLeft = function(a) {
        if ("levels1" == Preferences.mainMenu.mainmenu.currentLabel || "levels1right" == Preferences.mainMenu.mainmenu.currentLabel)
            Preferences.mainMenu.needFrameName = "mainmenuright";
        else if ("levels2" == Preferences.mainMenu.mainmenu.currentLabel)
            Preferences.mainMenu.needFrameName = "levels1right";
        else
            return;
        Preferences.mainMenu.inProgress = !0;
        1 == Preferences.mainMenu.curList ? Preferences.mainMenu.curList = 0 : 0 == Preferences.mainMenu.curList && (Preferences.mainMenu.curList = 1);
        Preferences.bSoundOff || createjs.Sound.play("TVzhuh");
...
var Eyes = function(g) {
    ...
    b.setEyes = function(a) {
        (this.needOpen = a) ? ("end" != this.ey1.currentLabel && Preferences.playTo(this.ey1, "end"),
        "end" != this.ey2.currentLabel && Preferences.playTo(this.ey2, "end")) : ("start" != this.ey1.currentLabel && Preferences.reversePlayTo(this.ey1, "start"),
        "start" != this.ey2.currentLabel && Preferences.reversePlayTo(this.ey2, "start"))
    }
    ;
    b.setZr = function(a) {
        if (-1 != b.lookTo.x) {
    ...
    b.setMc = function(a) {
        ...
        this.zrCurPos.x != 2 * this.MAX_ZRACH_OFFSET && (this.zr1.x = this.zrCurPos.x,
        this.zr1.y = this.zrCurPos.y,
        this.zr2.x = this.zrCurPos.x,
        this.zr2.y = this.zrCurPos.y);
        this.setZr(this.zr1);
        this.setZr(this.zr2);
        this.isDead ? (this.zr1.gotoAndStop(1),
        this.zr2.gotoAndStop(1)) : (this.zr1.gotoAndStop(0),
        this.zr2.gotoAndStop(0));
        0 == this.mc.hasEventListener("tick") && this.mc.addEventListener("tick", this.onFrame)
    }
    ;
    ...
    b.onRemoved = function(a) {
        this.ey1 && (this.needFrame = this.ey1.currentFrame,
        this.ey1.stop(),
        this.ey2.stop(),
        this.zrCurPos.x = this.zr1.x,
        this.zrCurPos.y = this.zr1.y)
    }
    ;
    b.setDead = function(a) {
        (this.isDead = a) ? (this.zr1.gotoAndStop(1),
        this.zr2.gotoAndStop(1)) : (this.zr1.gotoAndStop(0),
        this.zr2.gotoAndStop(0))
    }
    ;
...
var Game = function(g) {
    ...
    b.prototype.startLevel = function() {
        this.levelCur && (this.levelCur.parent.removeChild(this.levelCur),
        this.levelCur.deinit(),
        this.levelCur = null);
        this.levelNext && (this.levelNext.parent.removeChild(this.levelNext),
        this.levelNext.deinit(),
        this.levelNext = null);
        this.levelLeyerCur && (this.levelCur = new Level(this.curLevelNum),
        this.levelLeyerCur.addChild(this.levelCur),
        Preferences.lvlLink = this.levelCur,
        this.levelCur.init());
        this.levelLeyerNext && (this.levelNext = new Level(this.nextLevelNum),
        this.levelLeyerNext.addChild(this.levelNext),
        this.levelNext.init(),
        Preferences.lvlLink = this.levelNext)
    }
    ;
    ...
    b.prototype.swaplevel = function(a) {
        this.levelNext && (this.levelCur && (this.levelCur.parent.removeChild(this.levelCur),
        this.levelCur.deinit(),
        this.levelCur = null),
        this.levelCur = this.levelNext,
        a.addChild(this.levelCur),
        this.levelNext = null,
        this.levelLeyerCur = a,
        this.levelLeyerNext = null)
    }
    ;
    return b
}(createjs.MovieClip);
...
var Dumper = function() {
    ...
    g.dump = function(b, a) {
        ...
        if (b.cacheCanvas || a)
            c = !0;
        for (a = 0; a < b.numChildren; a++)
            b.children[a].children ? this.dump(b.children[a], c) || (d = !0) : b.children[a].visible && (d = !0);
        if (d && !c && b.visible) {
            c = b.parent;
            d = b.visible;
  ...
  , Level = function(g) {
    ...
    b.prototype.init = function() {
        if (31 == this.lvlNum)
            this.lvl31 = new Win31,
            this.lvl31.stop(),
            this.lvl31.init(),
            this.addChild(this.lvl31);
        else {
            var a = Preferences.getLevelConfigFromXml(this.lvlNum);
            if (!a)
                throw Error("\u0423\u0440\u043e\u0432\u0435\u043d\u044c " + this.lvlNum + " \u043d\u0435 \u043d\u0430\u0439\u0434\u0435\u043d");
            var b;
            ...
            var d;
            lib["bLevel" + this.lvlNum.toString()] && (d = b = new (lib["bLevel" + this.lvlNum.toString()]),
            d.cache(0, 0, 800, 600),
            this.bFon.addChild(d));
            for (var f = Preferences.CELL_NUM_X - 1; 0 <= f; f--)
                for (var e = Preferences.CELL_NUM_Y - 1; 0 <= e; e--)
                    a[f][e] && (b = LevelPart.Create(f, e, a[f][e], !1),
                    this.lvlParts.push(b),
                    a[f][e] < LevelPart.SNAKE_BODY_END ? this.snake.addPart(b) : (b.mInner && this.mFon.addChild(b.mInner),
                    b.bInner && this.mFon.addChild(b.bInner),
                    b.fInner && this.fFonItems.addChild(b.fInner)));
            lib["fLevel" + this.lvlNum.toString()] && (d = b = new (lib["fLevel" + this.lvlNum.toString()]),
            d.cache(0, 0, 800, 600),
            this.fFon.addChild(d));
            lib["mLevel" + this.lvlNum.toString()] && (this.mFonInner = b = new (lib["mLevel" + this.lvlNum.toString()]),
            d && (this.mFonInner.cache(0, 0, 800, 600),
            this.mFon.addChild(this.mFonInner)));
            this.addChildAt(this.snake, this.getChildIndex(this.fFon));
            this.snake.build(!1);
            this.snake.SetLastMoveDir();
            this.snake.checkHeadForWallAhead(!1) ? SnakePart.setNextHeadAnim(SnakePart.headHit, !1, !0, !0) : this.snake.checkHeadForFruitAround(!0, !1, !1);
    ...
    b.prototype.onFrame = function(a) {
        a = Preferences.CELL_NUM_Y * Preferences.CELL_SIZE;
                    ...
                    for (var l = 0; l < e.lvlParts.length; l++) {
                        if (k.type == LevelPart.SNAKE_BODY_START)
                            if (e.lvlParts[l].type == LevelPart.BLOCK_GOAL) {
                                ...
                                e.lvlParts[l].type == LevelPart.BLOCK_SPIKES && 1 == Math.abs(e.lvlParts[l].i - k.i) + Math.abs(e.lvlParts[l].j - k.j) && (f = e.lvlParts[l]);
                        if (k.type == LevelPart.BLOCK_MOVABLE) {
                            if (!(e.lvlParts[l].type == LevelPart.BLOCK_SPIKES || e.lvlParts[l].j <= k.j)) {
                            ...
                            e.lvlParts[l].i != k.i || e.lvlParts[l].type < LevelPart.SNAKE_BODY_END || (k.type == LevelPart.SNAKE_BODY_START && b > (e.lvlParts[l].j - k.j - 1) * Preferences.CELL_SIZE && (b = (e.lvlParts[l].j - k.j - 1) * Preferences.CELL_SIZE),
                            k.j < e.lvlParts[l].j && (e.lvlParts[l].type == LevelPart.BLOCK_SPIKES ? h >= (e.lvlParts[l].j - k.j - 1) * Preferences.CELL_SIZE && (h = (e.lvlParts[l].j - k.j - 1) * Preferences.CELL_SIZE) : a >= (e.lvlParts[l].j - k.j - 1) * Preferences.CELL_SIZE && (a = (e.lvlParts[l].j - k.j - 1) * Preferences.CELL_SIZE)),
                            k.j + 1 != e.lvlParts[l].j || e.snake.isTail(k) || (e.isSnakeOnTale = !1))
                    }
                    k.type == LevelPart.BLOCK_MOVABLE && n != k.j && (k.fall(n),
                    g = !0)
                }
            a && (h != Preferences.CELL_NUM_Y * Preferences.CELL_SIZE && (0 == h && (e.snake.onSpikes(),
            a = h + Preferences.CELL_SIZE),
            h != Preferences.CELL_NUM_Y * Preferences.CELL_SIZE && h < a && (e.snake.onSpikes(),
            a = h + Preferences.CELL_SIZE)),
            e.snake.startFall(a));
            2.82842712474619 >= d ? (Eyes.setLookTo(q.x + 25, q.y + 25),
            Eyes.setEyes(!0)) : f ? (Eyes.setLookTo(f.x + 25, f.y + 25),
            Eyes.setEyes(!0)) : (Eyes.setLookTo(-1, -1),
            Eyes.setEyes(!1));
            if (0 == e.nSkipFrames) {
                if (e.moveSnake)
                    switch (e.nSkipFrames = Preferences.STEP_TIMEOUT,
                    e.snake.move(e.moveSnake, e.isSnakeOnTale),
                    e.moveSnake) {
                    case e.KEYCODE_LEFT:
                    ...
                    case e.KEYCODE_RIGHT:
                        ...
                        break;
                    case e.KEYCODE_UP:
                        2 <= e.nButtonPressCountU && (e.moveSnake &= ~Snake.MOVE_UP);
                        break;
                    case e.KEYCODE_DOWN:
                        2 <= e.nButtonPressCountD && (e.moveSnake &= ~Snake.MOVE_DOWN)
                    }
            } else
                e.snake.bSnakeMoving || e.snake.bSnakeJumping || e.snake.bSnakeFalling || e.nSkipFrames--;
    ...
    b.prototype.checkForNoMove = function() {
        var a = 4
          ...
          , f = !1;
        this.snake.bIsSnakeVertical && this.isSnakeOnTale && (f = !0,
        a--);
    ...
    ;
    b.prototype.getBlockType = function(a, b) {
    ...
    b.prototype.moveMovable = function(a, b, d) {
        ...
        if ((a = this.getBlock(b, d)) && (a.isFalling || a.isMoving))
            return !1;
        a = this.getBlock(c, e);
        if (null != a && 0 != a.type && a.type != LevelPart.BLOCK_SPIKES)
            return !1;
    ...
    b.getCellRect = function(a, b) {
        return new createjs.Rectangle(Preferences.FIRST_CELL_OFFSET_X + a * Preferences.CELL_SIZE,Preferences.FIRST_CELL_OFFSET_Y + b * Preferences.CELL_SIZE,Preferences.CELL_SIZE,Preferences.CELL_SIZE)
    }
    ;
    b.coordToCell = function(a, b) {
        ...
        if (a.x >= Preferences.CELL_NUM_X || a.y >= Preferences.CELL_NUM_Y || 0 > a.x || 0 > a.y)
            a.x = -1,
            a.y = -1;
        return a
    }
    ...
    b.prototype.isGoalAround = function(a, b) {
        for (var c = 0; c < this.lvlParts.length; c++)
            for (var f = -1; 1 >= f; f++)
                for (var e = -1; 1 >= e; e++)
                    if (0 != Math.abs(f) - Math.abs(e) && this.lvlParts[c].type == LevelPart.BLOCK_GOAL && this.lvlParts[c].i + f == a && this.lvlParts[c].j + e == b)
                        return !0;
        return !1
    }
    ;
    b.prototype.needMovingOn = function(a, b, d) {
        a = 0;
        var c = !1;
        if (0 > b || 0 > d || b >= Preferences.CELL_NUM_X || d >= Preferences.CELL_NUM_Y)
            return LevelPart.BLOCK_NORMAL;
    ...
    b.prototype.changeZForMovable = function(a, b) {
        if (b)
            this.mFon.getChildIndex(this.mFonInner) > this.mFon.getChildIndex(a.bInner) && this.mFon.setChildIndex(a.bInner, this.mFon.numChildren - 1),
            this.mFon.getChildIndex(this.mFonInner) < this.mFon.getChildIndex(a.mInner) && this.mFon.setChildIndex(a.mInner, 0);
        else {
            this.mFon.getChildIndex(this.mFonInner) < this.mFon.getChildIndex(a.bInner) && this.mFon.setChildIndex(this.mFonInner, this.mFon.numChildren - 1);
            this.Rearrange(a);
            ...
            for (var c = 0; c < this.lvlParts.length; c++)
                if (null != this.lvlParts[c] && this.lvlParts[c].mInner && this.lvlParts[c] != a) {
                    ...
                    null != this.lvlParts[c].bInner && (f = this.mFon.getChildIndex(this.lvlParts[c].bInner),
                    (a.i < this.lvlParts[c].i && b < f || a.i > this.lvlParts[c].i && b > f) && this.mFon.setChildIndex(a.mInner, f))
                }
            b = this.mFon.getChildIndex(a.bInner);
            for (c = 0; c < this.lvlParts.length; c++)
                null != this.lvlParts[c] && null != this.lvlParts[c].bInner && this.lvlParts[c] != a && (f = this.mFon.getChildIndex(this.lvlParts[c].bInner),
                (a.i < this.lvlParts[c].i && b < f || a.i > this.lvlParts[c].i && b > f) && this.mFon.setChildIndex(a.bInner, f),
                null != this.lvlParts[c].mInner && (f = this.mFon.getChildIndex(this.lvlParts[c].mInner),
                (a.i < this.lvlParts[c].i && b < f || a.i > this.lvlParts[c].i && b > f) && this.mFon.setChildIndex(a.bInner, f)))
        }
    }
    ;
    b.prototype.Rearrange = function(a) {
        var b = this.mFon.getChildIndex(a.mInner);
        for (var d = 0; d < this.lvlParts.length; d++)
            if (null != this.lvlParts[d] && null != this.lvlParts[d].mInner && this.lvlParts[d].i == a.i) {
                ...
                null != this.lvlParts[d].bInner && (f = this.mFon.getChildIndex(this.lvlParts[d].bInner),
                (a.j < this.lvlParts[d].j && b < f || a.j > this.lvlParts[d].j && b > f) && this.mFon.setChildIndex(a.mInner, f))
            }
        b = this.mFon.getChildIndex(a.bInner);
        for (d = 0; d < this.lvlParts.length; d++)
            null != this.lvlParts[d] && null != this.lvlParts[d].bInner && this.lvlParts[d].i == a.i && (f = this.mFon.getChildIndex(this.lvlParts[d].bInner),
            (a.j < this.lvlParts[d].j && b < f || a.j > this.lvlParts[d].j && b > f) && this.mFon.setChildIndex(a.bInner, f),
            null != this.lvlParts[d].mInner && (f = this.mFon.getChildIndex(this.lvlParts[d].mInner),
            (a.j < this.lvlParts[d].j && b < f || a.j > this.lvlParts[d].j && b > f) && this.mFon.setChildIndex(a.bInner, f)))
    }
    ;
    return b
...
var LevelPart = function(g) {
    function b(a, c, d, f) {
        ...
        case b.BLOCK_GOAL:
            ...
            for (a = 0; a < e.mInner.numChildren; a++)
                e.mInner.getChildAt(a).cache(-29, -25, 60, 60);
            break;
        case b.BLOCK_END:
        ...
        e.bInner && (Preferences.prepareMC(e.bInner),
        e.bInner.x = c.x,
        e.bInner.y = c.y,
        e.bInner.name = "bpart" + d);
        e.mInner && (Preferences.prepareMC(e.mInner),
        e.mInner.x = c.x,
        e.mInner.y = c.y,
        e.mInner.name = "mpart" + d);
        Preferences.prepareMC(e.fInner);
        d == b.BLOCK_END && (e.fInner.play(),
        e.fInner.gotoAndPlay(0),
        e.fInner.inner.inner.play());
        e.fInner.x = c.x;
        e.fInner.y = c.y;
    ...
    __extends(b, g);
    b.Create = function(a, c, d, f) {
        void 0 === f && (f = !0);
        return d < b.SNAKE_BODY_END ? (f = b.savedSnakeParts[d],
        f.setParams(a, c, d, !1),
        f) : new b(a,c,d,f)
    }
    ;
    b.prototype.removeFromLvl = function() {
        this.type < b.SNAKE_BODY_END || (this.type == b.BLOCK_GOAL ? (this.fInner && Preferences.playToEndThenRemove(this.fInner),
        this.bInner && Preferences.playToEndThenRemove(this.bInner),
        this.mInner && Preferences.playToEndThenRemove(this.mInner)) : (this.bInner && this.bInner.parent.removeChild(this.bInner),
        this.fInner && this.fInner.parent.removeChild(this.fInner),
    ...
    b.prototype.onGameTick = function() {
        !this.isFalling && this.needPlayFall && (this.needPlayFall = !1,
        Preferences.bSoundOff || createjs.Sound.play("RockFall"));
        if (this.isMoving && !createjs.Tween.hasActiveTweens(this.fInner)) {
            if (this.isMoving = !1,
            this.fInner.x < 2 * -Preferences.CELL_SIZE || this.fInner.x > 800 + 2 * Preferences.CELL_SIZE || this.fInner.y < 2 * -Preferences.CELL_SIZE || this.fInner.y > 600 + 2 * Preferences.CELL_SIZE)
                return this.fInner && (this.fInner.visible = !1),
                this.bInner && (this.bInner.visible = !1),
                this.mInner && (this.mInner.visible = !1),
                !1
        } else
            this.isFalling && (this.needPlayFall = !1,
            this.bInner && (this.bInner.y = Preferences.ChangeNumberWithCap(this.bInner.y, this.m_nCurSpeed, this.m_nFallTo)),
            this.fInner && (this.fInner.y = Preferences.ChangeNumberWithCap(this.fInner.y, this.m_nCurSpeed, this.m_nFallTo)),
            this.mInner && (this.mInner.y = Preferences.ChangeNumberWithCap(this.mInner.y, this.m_nCurSpeed, this.m_nFallTo)),
            this.m_nCurSpeed += Preferences.SNAKE_FALL_ACELERATION,
            this.fInner.y == this.m_nFallTo && (this.needPlayFall = !0,
            this.isFalling = !1,
            Preferences.lvlLink && Preferences.lvlLink.Rearrange(this)),
            this.fInner.x < 2 * -Preferences.CELL_SIZE || this.fInner.x > 800 + 2 * Preferences.CELL_SIZE || this.fInner.y < 2 * -Preferences.CELL_SIZE || this.fInner.y > 600 + 2 * Preferences.CELL_SIZE) && (this.needPlayFall && (Preferences.bSoundOff || createjs.Sound.play("RockFall")),
            this.needPlayFall = !1,
            this.fInner && (this.fInner.visible = !1),
            this.bInner && (this.bInner.visible = !1),
            this.mInner && (this.mInner.visible = !1));
        return !0
    }
    ...
    b.prototype.move = function(a, b) {
        if (!(this.isMoving && createjs.Tween.hasActiveTweens(this.fInner) || this.isFalling)) {
            if (1 < Math.abs(a - this.i) || 1 < Math.abs(b - this.j) || 1 != Math.abs(a - this.i) && 1 != Math.abs(b - this.j))
                throw Error("\u041f\u043e\u043f\u044b\u0442\u043a\u0430 \u0441\u0434\u0432\u0438\u043d\u0443\u0442\u044c \u0431\u043b\u043e\u043a \u043d\u0430 \u043d\u0435\u0441\u0432\u044f\u0437\u0430\u043d\u043d\u0443\u044e \u043a\u043b\u0435\u0442\u043a\u0443 di:" + (a - this.i) + " dj: " + (b - this.j));
    ...
    b.prototype.positionChanged = function(a) {
        ...
        5 == this.m_TweeningFrames && this.bInner.x < this.i * Preferences.CELL_SIZE && Preferences.lvlLink && Preferences.lvlLink.changeZForMovable(a.currentTarget.target.parent, !0)
    }
    ;
    b.prototype.fall = function(a) {
        this.isMoving || this.isFalling || (this.isFalling = !0,
        this.m_nCurSpeed = Preferences.SNAKE_FALL_START_SPEED,
        this.m_nFallTo = Level.cellToCoord(0, a).y,
        this.j = a)
    }
    ;
...
var Snake = function(g) {
    function b(a, b) {
        ...
        SnakePart.staticHeadMask && (SnakePart.staticHeadMask.gotoAndStop(0),
        SnakePart.staticHeadMask.autoReset = !1);
        c.movingOnPlace = b;
        c.lvlLink = a;
        return c
    }
    ...
    b.prototype.addPart = function(a) {
        for (var b = 0, d = this.snakeParts; b < d.length; b++)
            if (d[b].type == a.type)
                throw Error("\u041f\u043e\u0432\u0442\u043e\u0440\u043d\u043e\u0435 \u0434\u043e\u0431\u0430\u0432\u043b\u0435\u043d\u0438\u0435 \u0441\u0435\u0433\u043c\u0435\u043d\u0442\u0430 \u0441 \u043e\u0434\u0438\u043d\u0430\u043a\u043e\u0432\u044b\u043c\u0438 \u0438\u043d\u0434\u0435\u043a\u0441\u0430\u043c\u0438");
        ...
        if (0 != this.snakeParts.length)
            if (a || 1 != this.snakeParts.length) {
                if (2 <= this.snakeParts.length) {
                    ...
                    d.i < f.i && (a || (d.createLine(!1, !0, !1, !1, !0),
                    this.lastAnimMovingDir = b.MOVE_LEFT),
                    f.nextOffX = d.nextOffX - 2,
                    f.nextOffY = d.nextOffY,
                    f.createLine(!1, !0, !0, 2 == this.snakeParts.length, !1, !c && 3 == this.snakeParts.length, c, d.bReversedCorner, !d.bCorner),
                    this.bIsSnakeVertical = !1);
                    d.i > f.i && (a || (d.createLine(!1, !1, !1, !1, !0),
                    this.lastAnimMovingDir = b.MOVE_RIGHT),
                    f.nextOffX = d.nextOffX + 2,
                    f.nextOffY = d.nextOffY,
                    f.createLine(!1, !1, !0, 2 == this.snakeParts.length, !1, !c && 3 == this.snakeParts.length, c, d.bReversedCorner, !d.bCorner),
                    this.bIsSnakeVertical = !1);
                    d.j < f.j && (a || (d.createLine(!0, !0, !1, !1, !0),
                    this.lastAnimMovingDir = b.MOVE_UP),
                    f.nextOffX = d.nextOffX,
                    f.nextOffY = d.nextOffY - 2,
                    f.createLine(!0, !0, !0, 2 == this.snakeParts.length, !1, !c && 3 == this.snakeParts.length, c, d.bReversedCorner, !d.bCorner));
                    d.j > f.j && (a || (d.createLine(!0, !1, !1, !1, !0),
                    this.lastAnimMovingDir = b.MOVE_DOWN),
                    f.nextOffX = d.nextOffX,
                    f.nextOffY = d.nextOffY + 2,
                    f.createLine(!0, !1, !0, 2 == this.snakeParts.length, !1, !c && 3 == this.snakeParts.length, c, d.bReversedCorner, !d.bCorner));
                    this.movingOnPlace && (f.playGraph(),
                    d.playGraph());
                    d = f
                }
                a = d.bVertical;
                for (var e = 2; e < this.snakeParts.length; e++)
                    f = this.snakeParts[e],
                    this.setChildIndex(f, this.snakeParts.length - e - 1),
                    d.i < f.i && (a && d.createCorner(d.bReverse, !0, !0, d.bOdd, !1, !c && e == this.snakeParts.length - 1),
                    f.nextOffX = d.nextOffX - 2,
                    f.nextOffY = d.nextOffY,
                    f.createLine(!1, !0, !d.bOdd, e == this.snakeParts.length - 1, !1, !c && e == this.snakeParts.length - 2, c, d.bReversedCorner, !d.bCorner),
                    this.bIsSnakeVertical = !1),
                    d.i > f.i && (a && d.createCorner(d.bReverse, !1, !0, d.bOdd, !1, !c && e == this.snakeParts.length - 1),
                    f.nextOffX = d.nextOffX + 2,
                    f.nextOffY = d.nextOffY,
                    f.createLine(!1, !1, !d.bOdd, e == this.snakeParts.length - 1, !1, !c && e == this.snakeParts.length - 2, c, d.bReversedCorner, !d.bCorner),
                    this.bIsSnakeVertical = !1),
                    d.j < f.j && (a || d.createCorner(!0, d.bReverse, !1, d.bOdd, !1, !c && e == this.snakeParts.length - 1),
                    f.nextOffX = d.nextOffX,
                    f.nextOffY = d.nextOffY - 2,
                    f.createLine(!0, !0, !d.bOdd, e == this.snakeParts.length - 1, !1, !c && e == this.snakeParts.length - 2, c, d.bReversedCorner, !d.bCorner)),
                    d.j > f.j && (a || d.createCorner(!1, d.bReverse, !1, d.bOdd, !1, !c && e == this.snakeParts.length - 1),
                    f.nextOffX = d.nextOffX,
                    f.nextOffY = d.nextOffY + 2,
                    f.createLine(!0, !1, !d.bOdd, e == this.snakeParts.length - 1, !1, !c && e == this.snakeParts.length - 2, c, d.bReversedCorner, !d.bCorner)),
                    a = d.bVertical,
                    d = f;
                for (e = 0; e < this.snakeParts.length; e++)
                    this.snakeParts[e].x -= this.snakeParts[e].neddOffX,
                    this.snakeParts[e].y -= this.snakeParts[e].neddOffY,
                    this.snakeParts[e].x += this.snakeParts[e].nextOffX,
                    this.snakeParts[e].y += this.snakeParts[e].nextOffY,
                    this.snakeParts[e].neddOffX = this.snakeParts[e].nextOffX,
                    this.snakeParts[e].neddOffY = this.snakeParts[e].nextOffY;
                this.bSnakeMoving = this.movingOnPlace
            } else
                f = this.snakeParts[0],
                f.createLine(!1, !1, !1, !1, !0)
    }
    ;
    b.prototype.startFall = function(a) {
        if (!(this.bSnakeMoving || this.bSnakeFalling || this.bSnakeJumping || this.bGoalTaken)) {
            this.m_nCurSpeed = Preferences.SNAKE_FALL_START_SPEED;
            ...
            a == Preferences.CELL_SIZE && (a = this.checkHeadForFruitAround(!1, !1, !0),
            !b && a ? SnakePart.setNextHeadAnim(SnakePart.headOpen, !1, !1, !0) : b || SnakePart.setNextHeadAnim(SnakePart.headStatic, !1, !1, !0))
        }
    }
    ;
    b.prototype.checkFall = function() {
        if (this.bSnakeFalling) {
            var a = 50 * Math.floor(this.y / 50);
            this.y = Preferences.ChangeNumberWithCap(this.y, this.m_nCurSpeed, this.m_nFallTo);
            if (50 * Math.floor(this.y / 50) != a) {
                a = 0;
                for (var b = this.snakeParts; a < b.length; a++)
                    b[a].j++;
                ...
                if (50 >= this.m_nFallTo - this.y && !b || !a && b) {
                    ...
                    a || (d ? SnakePart.setNextHeadAnim(SnakePart.headOpen, !1, !1, !b) : SnakePart.setNextHeadAnim(SnakePart.headStatic, !1, !1, !b))
                }
            }
            this.m_nCurSpeed += Preferences.SNAKE_FALL_ACELERATION;
        ...
        if (!(this.bSnakeMoving || this.bSnakeFalling || this.bSnakeJumping)) {
            ...
            case b.MOVE_UP:
                ...
                if (this.bIsSnakeVertical && c) {
                    ...
                    Preferences.bSoundOff || createjs.Sound.play("TJump"));
                    return
                }
                break;
            case b.MOVE_DOWN:
            ...
            if (!this.bWin)
                switch (p = Preferences.lvlLink.needMovingOn(a, g, h),
                p) {
                ...
                case LevelPart.BLOCK_END:
                    this.bWin = !0;
                    Preferences.bSoundOff ? Preferences.gameMenuChanger.showNextMenu(!1) : (createjs.Sound.play("TPortal_1").on("complete", this.onEndSoundComplete),
                    Preferences.nextMenu.inProgress = !0);
                ...
                case LevelPart.BLOCK_MOVABLE:
                    ...
                    if (!Preferences.lvlLink.moveMovable(a, g, h))
                        return;
                    n = !0;
                    k && (Preferences.bSoundOff || createjs.Sound.play("TRock"),
                    SnakePart.setNextHeadAnim(SnakePart.headHit, !1, !0));
                    p == LevelPart.BLOCK_ON_SPYKES && (Preferences.bSoundOff || createjs.Sound.play("TDead"),
                    this.bFail = !0);
                    break;
                case 0:
                    break;
            ...
            d.nextI = g;
            d.nextJ = h;
            this.bGoalTaken && (this.build(!1, !0),
            Preferences.lvlLink.removeGoal(g, h));
            k || (!this.bGoalTaken || Preferences.lvlLink.getBlockType(g + (g - f), h + (h - e)) != LevelPart.BLOCK_NORMAL && Preferences.lvlLink.getBlockType(g + (g - f), h + (h - e)) != LevelPart.BLOCK_MOVABLE ? Preferences.lvlLink.getBlockType(g + g - f, h + h - e) == LevelPart.BLOCK_NORMAL || Preferences.lvlLink.getBlockType(g + g - f, h + h - e) == LevelPart.BLOCK_MOVABLE ? SnakePart.setNextHeadAnim(SnakePart.headHit) : this.bGoalTaken ? SnakePart.setNextHeadAnim(SnakePart.headEat) : this.checkHeadForFruitAround(!1, !0, !1) ? (l = !0,
            SnakePart.setNextHeadAnim(SnakePart.headOpen)) : SnakePart.setNextHeadAnim(SnakePart.headStatic) : SnakePart.setNextHeadAnim(SnakePart.headEatHit),
            n ? Preferences.bSoundOff || createjs.Sound.play("TRock") : this.bGoalTaken ? Preferences.bSoundOff || createjs.Sound.play("TEat") : l ? Preferences.bSoundOff || createjs.Sound.play("TOpen") : Preferences.bSoundOff || createjs.Sound.play("Tsound"));
            this.bSnakeMoving = !0;
            ...
            for (a = 0; a < this.snakeParts.length; a++)
                this.snakeParts[a].startAnimationMoving(g, h)
        }
    }
    ;
    ...
    b.prototype.checkHeadForWallAhead = function(a) {
        ...
        var c = this.snakeParts[0]
          , d = 0
          , f = 0;
        if (this.lastAnimMovingDir == b.MOVE_UP) {
            if (a)
                return !1;
            f--
        }
        this.lastAnimMovingDir == b.MOVE_LEFT ? (d--,
        a && f++) : this.lastAnimMovingDir == b.MOVE_RIGHT ? (d++,
        a && f++) : this.lastAnimMovingDir == b.MOVE_DOWN && (a ? f += 2 : f++);
    ...
    b.prototype.checkHeadForFruitAround = function(a, b, d) {
        if (Preferences.lvlLink) {
            var c = this.snakeParts[0];
            if (c) {
                if (!b && Preferences.lvlLink.isGoalAround(c.i, c.j + (d ? 1 : 0)) || b && Preferences.lvlLink.isGoalAround(c.nextI, c.nextJ))
                    return a && c.setFirstHeadAnim(SnakePart.headOpen),
                    !0;
    ...
    b.prototype.checkMove = function() {
        ...
        if (this.bSnakeMoving) {
            ...
            for (var a = 0, b = this.snakeParts; a < b.length; a++) {
                var d = b[a];
                d.j < this.minJ ? (this.minJ = d.j,
                this.topBlock = d) : d.j > this.maxJ && (this.maxJ = d.j);
            ...
            if (!this.bSnakeMoving) {
                ...
                if (0 == this.bGoalTaken) {
                    ...
                    f.type = 2;
                    for (var e = 0, g = this.snakeParts; e < g.length; e++)
                        d = g[e],
                        d.type >= f.type && d.type != b.type && d.type++;
                    this.snakeParts.splice(1, 0, f)
                } else {
                    b = this.snakeParts[this.snakeParts.length - 1];
                    d = b.i;
                    f = b.j;
                    for (e = this.snakeParts.length - 2; 0 <= e; e--)
                        this.snakeParts[e + 1].nextI = this.snakeParts[e].i,
                        this.snakeParts[e + 1].nextJ = this.snakeParts[e].j,
                        this.snakeParts[e + 1].stopAnimationMoving();
                    this.newBlock = LevelPart.Create(d, f, b.type + 1);
                ...
                this.build(!1);
                if (this.bWin)
                    if (this.numOfHideSegments == this.snakeParts.length)
                        this.lvlLink.win();
                    else
                        for (this.move(this.lastAnimMovingDir),
                        this.setMaskOnWin(),
                        0 == this.numOfHideSegments && 0 == this.winStep ? (a = this.snakeParts[this.numOfHideSegments],
                        this.winStep++,
                        a && a.setMask(2)) : (0 == this.numOfHideSegments && this.snakeParts[0].setMask(2),
                        this.winStep = 0,
                        this.numOfHideSegments++,
                        this.setMaskOnWin(),
                        e = this.numOfHideSegments,
                        e < this.snakeParts.length && this.snakeParts[e].setMask(2)),
                        e = 0; e < this.snakeParts.length; e++)
                            this.snakeParts[e].visible = e < this.numOfHideSegments ? !1 : !0;
                else
                    this.bFail && Preferences.lvlLink.fail()
            }
        }
    }
    ;
...
var SnakePart = function(g) {
    function b(a, c, d, f) {
        ...
        a.mcCornerTail2 = new lib.ugol1hvost;
    ...
    b.prototype.setParams = function(a, c, d, f) {
        ...
        this.bIsAnimMoving = this.bIsPretail = this.bIsTail = this.bIsHead = this.bToLelt = this.bToTop = this.bCorner = this.bOdd = this.bVertical = this.bReverse = !1;
    ...
    b.prototype.resetMCProp = function(a) {
        ...
        if (a.maskArray)
            for (a.eblo ? (a.eblo.mask = a.maskArray[0],
            a.mask = null) : a.mask = a.maskArray[0],
            b = 0; b < a.maskArray.length; b++)
                a.maskArray[b].x = a.maskArray[b].svdX,
                a.maskArray[b].y = a.maskArray[b].svdY,
                a.maskArray[b].rotation = a.maskArray[b].svdRot,
                a.maskArray[b].scaleX = a.maskArray[b].svdScale,
                a.maskArray[b].scaleY = a.maskArray[b].svdScale
    }
    ;
    b.prototype.resetMC = function(a) {
        ...
        a.visible = !0;
        if (this.bl = a.blk)
            this.bl = this.bl.getChildAt(0);
        this.bl && (this.bl.scaleY = 1,
        this.bl.y = 0,
        this.bl.gotoAndStop(0));
        if (this.bl2 = a.blk2)
            this.bl2 = this.bl2.getChildAt(0);
        this.bl2 && (this.bl2.scaleY = 1,
        this.bl2.y = 0,
        this.bl2.gotoAndStop(0));
        var b = a.mask111;
        if (b) {
            Preferences.prepareMC(b);
            a.maskArray = [];
    ...
    b.prototype.setMask = function(a, b) {
        void 0 === b && (b = !1);
        this.inn.maskArray && (a >= this.inn.maskArray.length && (a = this.inn.maskArray.length - 1),
        this.inn.eblo ? b ? (this.inn.maskArray[a].rotation = this.inn.rotation,
        this.inn.maskArray[a].x = 25,
        this.inn.maskArray[a].y = 25,
        this.inn.maskArray[a].scaleX = .5,
        this.inn.maskArray[a].scaleY = .5,
        this.inn.mask = this.inn.maskArray[a]) : this.inn.eblo.mask = this.inn.maskArray[a] : (this.inn.maskArray[a].rotation = this.inn.rotation,
        this.inn.mask = this.inn.maskArray[a]))
    }
    ;
    b.prototype.createLine = function(a, c, d, f, e, g, h, m, k) {
        ...
        void 0 === m && (m = !1);
        void 0 === k && (k = !0);
        null != this.inn && (this.inn.visible = !1,
        this.inn.stop());
        this.bl2 = this.bl = null;
        f ? this.inn = d ? h ? this.mcTail2OnGrow : k ? this.mcTail2 : m ? this.mcTail2Corner : this.mcTail2Corner2 : h ? this.mcTail1OnGrow : k ? this.mcTail1 : m ? this.mcTail1Corner : this.mcTail1Corner2 : e ? (this.inn = this.mcHeadLine,
        b.mcHeadContainer = this.inn.eblo,
        b.mcHeadContainer = b.mcHeadContainer.eblo,
        b.curHead = b.HEAD_1,
        b.mcHeadContainer && (b.mcHeadContainer.scaleX = 1,
        b.mcHeadContainer.scaleY = 1,
        b.mcHeadContainer.y = 0,
        b.mcHeadContainer.x = 0,
        b.mcHeadinHead && (b.mcHeadContainer.addChild(b.mcHeadinHead),
        b.mcHeadinHead.puzo111.visible = !0))) : this.inn = g ? d ? this.mcLineTail2 : this.mcLineTail1 : d ? this.mcLine2 : this.mcLine1;
        this.resetMC(this.inn);
        !a && c && (this.bl && (this.bl.scaleY = -1,
        this.bl.y = 2 * Preferences.CELL_SIZE),
        this.bl2 && (this.bl2.scaleY = -1,
        this.bl2.y = 2 * Preferences.CELL_SIZE),
        this.inn.rotation = 180,
        this.inn.x = Preferences.CELL_SIZE,
        this.inn.y = Preferences.CELL_SIZE);
        a && !c && (this.inn.rotation = 90,
        this.inn.x = Preferences.CELL_SIZE,
        this.bl && (this.bl.scaleY = -1,
        this.bl.y = 2 * Preferences.CELL_SIZE),
        this.bl2 && (this.bl2.scaleY = -1,
    ...
    b.prototype.createCorner = function(a, c, d, f, e, g) {
        ...
        this.inn.stop());
        this.bl2 = this.bl = null;
        e ? (a && !c && d || a && c && !d || !a && c && d || !a && !c && !d ? (this.bReversedCorner = !1,
        this.inn = this.mcHeadCorner2,
        b.curHead = b.HEAD_2) : (this.bReversedCorner = !0,
        this.inn = this.mcHeadCorner,
        b.curHead = b.HEAD_3),
        b.mcHeadContainer = this.inn.eblo,
        b.mcHeadContainer = b.mcHeadContainer.eblo,
        b.mcHeadContainer && (b.mcHeadContainer.scaleX = 1,
        ...
        b.mcHeadContainer.x = 0),
        b.mcHeadinHead && (b.mcHeadContainer.addChild(b.mcHeadinHead),
        b.mcHeadinHead.puzo111.visible = !1)) : g ? a && !c && d || a && c && !d || !a && c && d || !a && !c && !d ? (this.bReversedCorner = !1,
        this.inn = f ? this.mcCornerTail2_2 : this.mcCornerTail1_2) : (this.bReversedCorner = !0,
        this.inn = f ? this.mcCornerTail2 : this.mcCornerTail1) : a && !c && d || a && c && !d || !a && c && d || !a && !c && !d ? (this.bReversedCorner = !1,
        this.inn = f ? this.mcCorner2_2 : this.mcCorner1_2) : (this.bReversedCorner = !0,
        this.inn = f ? this.mcCorner2 : this.mcCorner1);
        this.resetMC(this.inn);
        !a || c || d || (this.bl && this.bl.gotoAndStop(0),
        this.bl2 && this.bl2.gotoAndStop(0));
        a || c || !d || (this.inn.rotation = 90,
        this.inn.x = Preferences.CELL_SIZE,
        this.bl && this.bl.gotoAndStop(3),
        this.bl2 && this.bl2.gotoAndStop(3));
        a || !c || d || (this.bl && this.bl.gotoAndStop(1),
        this.bl2 && this.bl2.gotoAndStop(1),
        this.inn.rotation = 180,
        this.inn.x = Preferences.CELL_SIZE,
        this.inn.y = Preferences.CELL_SIZE);
        a && c && d && (this.inn.rotation = -90,
        this.inn.y = Preferences.CELL_SIZE,
        this.bl && this.bl.gotoAndStop(2),
        this.bl2 && this.bl2.gotoAndStop(2));
        a || c || d || (e && b.mcHeadContainer && (b.mcHeadContainer.scaleY = -1,
        b.mcHeadContainer.y = 2 * Preferences.CELL_SIZE),
        this.bl && this.bl.gotoAndStop(3),
        this.bl2 && this.bl2.gotoAndStop(3),
        this.inn.scaleY = -this.inn.scaleY,
        this.inn.y = Preferences.CELL_SIZE);
        a && c && !d && (e && b.mcHeadContainer && (b.mcHeadContainer.scaleY = -1,
        b.mcHeadContainer.y = 2 * Preferences.CELL_SIZE),
        this.bl && this.bl.gotoAndStop(2),
        this.bl2 && this.bl2.gotoAndStop(2),
        this.inn.scaleX = -this.inn.scaleX,
        this.inn.x = Preferences.CELL_SIZE);
        a && !c && d && (this.bl && this.bl.gotoAndStop(1),
        this.bl2 && this.bl2.gotoAndStop(1),
        e && b.mcHeadContainer && (b.mcHeadContainer.scaleY = -1,
        b.mcHeadContainer.y = 2 * Preferences.CELL_SIZE),
        this.inn.scaleX = -this.inn.scaleX,
        this.inn.rotation = 90,
        this.inn.x = Preferences.CELL_SIZE,
        this.inn.y = Preferences.CELL_SIZE);
        !a && c && d && (e && b.mcHeadContainer && (b.mcHeadContainer.scaleY = -1,
        b.mcHeadContainer.y = 2 * Preferences.CELL_SIZE),
    ...
    b.prototype.changeOdd = function() {
        this.bIsHead || this.bIsTail || (this.bOdd = !this.bOdd,
        this.bCorner ? this.createCorner(this.bToTop, this.bToLelt, this.bReverse, !this.bOdd, this.bIsHead, this.bIsPretail) : this.createLine(this.bVertical, this.bReverse, !this.bOdd, this.bIsTail, this.bIsHead, this.bIsPretail))
    }
    ;
    ...
    b.prototype.setFirstHeadAnim = function(a) {
        if (!this.bIsHead)
            throw Error("setFirstHeadAnim. \u041d\u0435 \u0433\u043e\u043b\u043e\u0432\u0430!");
        b.mcHeadContainer = this.inn.eblo;
        Preferences.prepareMC(b.mcHeadContainer);
        b.mcHeadContainer = b.mcHeadContainer.eblo;
        Preferences.prepareMC(b.mcHeadContainer);
    ...
    b.setNextHeadAnim = function(a, c, d, f) {
        ...
        var e = c || d;
        if (!c) {
            if (f && b.mcHeadinHead == b.headHit)
                return;
            if (b.mcHeadinHead == a) {
                d && b.mcHeadinHead == b.headHit && (b.mcHeadinHead.gotoAndStop(b.mcHeadinHead.totalFrames - 1),
                Preferences.stopEx(b.mcHeadinHead));
                return
            }
            if (b.mcHeadinHead == b.headHit)
                e = !0;
            else if (b.mcHeadinHead == b.headStatic)
                e = !0;
            else if (b.mcHeadinHead == b.headOpen)
                if (c = !1,
                9 <= b.headOpen.currentFrame && (c = !0),
                a == b.headHit ? a = b.headEatHit : a == b.headStatic ? c ? a = b.headLoss : b.mcHeadinHeadNext = b.headLoss : c || (b.mcHeadinHeadNext = a),
                c)
                    e = !0;
                else
                    return;
                ...
                if (a == b.headHit)
                    return;
                if (b.mcHeadinHead.currentFrame == b.mcHeadinHead.totalFrames - 1)
                    e = !0;
                else {
                ...
                b.mcHeadinHead == b.headEat && a != b.headStatic && (e = !0);
            b.mcHeadinHeadNext = a
        }
        null == b.mcHeadinHead ? (b.mcHeadinHead = a,
        b.mcHeadinHead.gotoAndStop(0),
        b.mcHeadContainer.addChild(b.mcHeadinHead),
        d ? (b.mcHeadinHead.gotoAndStop(b.mcHeadinHead.totalFrames - 1),
        Preferences.stopEx(b.mcHeadinHead)) : Preferences.playTo(b.mcHeadinHead, b.mcHeadinHead.totalFrames - 1, this.onHeadAnimEnd)) : e && (b.mcHeadinHeadNext = null,
        Preferences.stopEx(b.mcHeadinHead),
        Eyes.onRemoved(null),
        b.mcHeadContainer.removeChild(b.mcHeadinHead),
        b.mcHeadinHead = a,
        b.mcHeadinHead.gotoAndStop(0),
        b.mcHeadContainer.addChild(b.mcHeadinHead),
        Eyes.setMc(b.mcHeadinHead.glaza),
        d ? (b.mcHeadinHead.gotoAndStop(b.mcHeadinHead.totalFrames - 1),
        Preferences.stopEx(b.mcHeadinHead)) : Preferences.playTo(b.mcHeadinHead, b.mcHeadinHead.totalFrames - 1, this.onHeadAnimEnd));
    ...
    b.onHeadAnimEnd = function() {
        ...
        case b.headStatic:
            b.mcHeadinHeadNext && (b.setNextHeadAnim(b.mcHeadinHeadNext, !0),
            b.mcHeadinHeadNext = null);
            break;
        case b.headOpen:
            b.mcHeadinHeadNext ? (b.setNextHeadAnim(b.mcHeadinHeadNext, !0),
            b.mcHeadinHeadNext = null) : b.headOpen.gotoAndStop(b.headOpen.totalFrames - 1);
            break;
        case b.headEat:
            b.mcHeadinHeadNext ? (b.setNextHeadAnim(b.mcHeadinHeadNext, !0),
            b.mcHeadinHeadNext = null) : b.setNextHeadAnim(b.headStatic, !0);
            break;
        case b.headLoss:
            b.mcHeadinHeadNext ? (b.setNextHeadAnim(b.mcHeadinHeadNext, !0),
            b.mcHeadinHeadNext = null) : b.setNextHeadAnim(b.headStatic, !0);
        ...
        case b.headHit:
            b.mcHeadinHeadNext ? (b.setNextHeadAnim(b.mcHeadinHeadNext, !0),
            b.mcHeadinHeadNext = null) : b.headHit.gotoAndStop(b.headHit.totalFrames - 1);
            break;
        case b.headEatHit:
            b.mcHeadinHeadNext ? (b.setNextHeadAnim(b.mcHeadinHeadNext, !0),
            b.mcHeadinHeadNext = null) : b.headEatHit.gotoAndStop(b.headEatHit.totalFrames - 1)
        }
    }
    ;
    b.prototype.isStopped = function() {
        if (null == this.parent)
            return !0;
        if (this.isMoving || this.bIsAnimMoving && this.inn.currentFrame != this.inn.totalFrames - 1)
            return !1;
...
var win31instance, Win31 = function(g) {
    ...
    b.prototype.onKey = function(a) {
        ...
        case Preferences.KEYCODE_D:
        case Preferences.KEYCODE_UP:
            win31instance.win31.currentFrame != win31instance.win31.totalFrames - 1 && (0 == win31instance.win31.currentFrame ? Preferences.playTo(win31instance.win31, 19) : 57 <= win31instance.win31.currentFrame ? Preferences.playTo(win31instance.win31, win31instance.win31.totalFrames - 1) : 19 <= win31instance.win31.currentFrame && Preferences.playTo(win31instance.win31, 57))
        }
    }
    ;
    b.prototype.deinit = function() {
